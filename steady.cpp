...
void update_coefficients(){
	...
	for(i=3;i<=2*N-3;i=i+2)
	{
		for(j=4;j<=2*N-4;j=j+2)
		{
			...
			if(Fn>=0 && Fs>=0){
				if(Fe>=0 && Fw>=0){
					aP[i][j]=Fe*dy+Fn*dx+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=(Fw+Dw)*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=De*dy;
					aN[i][j]=Dn*dx;
					S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
					...
					aP[i][j]=-1*Fw*dy+Fe*dy+Fn*dx+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=Dw*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=De*dy;
					aN[i][j]=Dn*dx;
					...
					aP[i][j]=Fn*dx+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=(Dw+Fw)*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=(De-Fe)*dy;
					aN[i][j]=Dn*dx;
					...
					aP[i][j]=-Fw*dy+Fn*dx+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=Dw*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=(De-Fe)*dy;
					aN[i][j]=Dn*dx;
				...
				if(Fe>=0 && Fw>=0){
					...
					aP[i][j]=Fe*dy-Fw*dy+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=Dw*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=De*dy;
					aN[i][j]=(Dn-Fn)*dx;
					...
					aP[i][j]=De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=(Dw+Fw)*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=(De-Fe)*dy;
					aN[i][j]=(Dn-Fn)*dx;
					...
					aP[i][j]=-1*Fw*dy+De*dy+Dw*dy+Dn*dx+Ds*dx;
					aW[i][j]=Dw*dy;
					aS[i][j]=(Fs+Ds)*dx;
					aE[i][j]=(De-Fe)*dy;
					aN[i][j]=(Dn-Fn)*dx;
				...
				if(Fe>=0 && Fw>=0){
					...
					aE[i][j]=De*dy;
					aN[i][j]=Dn*dx;
					aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+Fe*dy-Fw*dy+Fn*dx-Fs*dx;
					S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
	...
	if(Fe>=0){
		if(Fw>=0 && Fn>=0){
			aP[i][j]=Fe*dy+Fn*dx+(3*mu*dx/dy)+(2*mu*dy/dx);
			aE[i][j]=mu*dy/dx;
			aN[i][j]=mu*dx/dy;
			aW[i][j]=0;
			aS[i][j]=0;
			...
			aP[i][j]=Fe*dy+(3*mu*dx/dy)+(2*mu*dy/dx);
			aE[i][j]=mu*dy/dx;
			...
			aP[i][j]=Fn*dx+Fe*dy+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aE[i][j]=mu*dy/dx;
			aN[i][j]=mu*dx/dy;
			aW[i][j]=0;
			aS[i][j]=0;
			...
			aP[i][j]=Fe*dy+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aE[i][j]=mu*dy/dx;
			aN[i][j]=mu*dx/dy - Fn*dx;
			aW[i][j]=0;
			aS[i][j]=0;
		...
		if(Fw>=0 && Fn>=0){
			aP[i][j]=Fn*dx+(3*mu*dx/dy)+(2*mu*dy/dx);
	...
	if(Fe>=0){
		...
		if(Fw>=0 && Fn>=0){
			...
			aP[i][j]=Fn*dx+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aW[i][j]=mu*dy/dx;
			aN[i][j]=mu*dx/dy;
			aE[i][j]=0;
			aS[i][j]=0;
			...
			aP[i][j]=(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aW[i][j]=mu*dy/dx;
			aN[i][j]=mu*dx/dy - Fn*dx;
			aE[i][j]=0;
			aS[i][j]=0;
	...
	if(Fe>=0){
		if(Fw>=0 && Fs>=0){
			...
			aW[i][j]=0;
			aN[i][j]=0;
			S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy+(2*Dn*vel*dx);
			...
			aP[i][j]=Fe*dy-Fs*dx+(3*mu*dx/dy)+(2*mu*dy/dx);
			aE[i][j]=mu*dy/dx;
			aS[i][j]=mu*dx/dy;
			aW[i][j]=0;
			aN[i][j]=0;
			...
			aP[i][j]=Fs*dx+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aE[i][j]=mu*dy/dx;
			aS[i][j]=mu*dx/dy;
			aN[i][j]=0;
			aW[i][j]=0;
		...
		if(Fw>=0 && Fs>=0){
			...
			aP[i][j]=-1*Fs*dx+(3*mu*dx/dy)+(2*mu*dy/dx);
			aE[i][j]=-1*Fe*dy+mu*dy/dx;
			aS[i][j]=mu*dx/dy;
			aW[i][j]=0;
			aN[i][j]=0;
			...
			aP[i][j]=-1*Fs*dx+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy;
			aE[i][j]=mu*dy/dx - Fe*dy;
			aS[i][j]=mu*dx/dy;
			aN[i][j]=0;
			aW[i][j]=0;
	...
	if(Fe>=0){
		if(Fw>=0 && Fs>=0){
			...
			aP[i][j]=-1*Fs*dx+(3*mu*dx/dy)+(2*mu*dy/dx)-Fw*dy+Fe*dy;
			aW[i][j]=mu*dy/dx;
			aS[i][j]=mu*dx/dy;
			aE[i][j]=0;
			aN[i][j]=0;
	...
	for(i=3;i<=2*N-3;i=i+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+Dw*dy+Fe*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+Dw*dy+Fe*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(u_star[i][j]-u_star[i-2][j])-Fw*dy*PSI[i][j-1]*(u_star[i][j]-u_star[i][j-2])-Fn*dx*PSI[i+1][j]*(u_star[i+2][j]-u_star[i][j])-Fe*dy*PSI[i][j+1]*(u_star[i][j+2]-u_star[i][j]));
			}
			else if(Fe*dy<0 && Fw*dy>=0){
	...
	for(i=3;i<=2*N-3;i=i+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=0;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+De*dy+Fe*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(u_star[i][j]-u_star[i-2][j])+Fw*dy*PSI[i][j-1]*(u_star[i][j]-u_star[i][j-2])-Fn*dx*PSI[i+1][j]*(u_star[i+2][j]-u_star[i][j])-Fe*dy*PSI[i][j+1]*(u_star[i][j+2]-u_star[i][j]));
			}
			else if(Fe*dy>=0 && Fw*dy<0){
				...
				aE[i][j]=0;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+De*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(u_star[i][j]-u_star[i-2][j])+Fw*dy*PSI[i][j-1]*(u_star[i][j]-u_star[i][j-2])-Fn*dx*PSI[i+1][j]*(u_star[i+2][j]-u_star[i][j])+Fe*dy*PSI[i][j+1]*(u_star[i][j+2]-u_star[i][j]));
			}
			else if(Fe*dy<0 && Fw*dy<0){
	...
	for(j=4;j<=2*N-4;j=j+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*Ds*dx+Fe*dy-Fw*dy+Fn*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy;
	...
	for(j=4;j<=2*N-4;j=j+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=0;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*Dn*dx+Fe*dy-Fw*dy-Fs*dx;
				S[i][j]=(P_star[i][j-1]-P_star[i][j+1])*dy+(2*Dn*dx-Fn*dx)*vel;
		...
		for(j=3;j<=2*N-3;j=j+2)
		{
			...
			if(Fn>=0 && Fs>=0){
				if(Fe>=0 && Fw>=0){
					...
					aE[i][j]=De*dy;
					aN[i][j]=Dn*dx;
					S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
	...
	if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*Dw*dy+Fe*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*Dw*dy+Fe*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(v_star[i][j]-v_star[i-2][j])-Fw*dy*PSI[i][j-1]*(v_star[i][j]-v_star[i][j-2])-Fn*dx*PSI[i+1][j]*(v_star[i+2][j]-v_star[i][j])-Fe*dy*PSI[i][j+1]*(v_star[i][j+2]-v_star[i][j]));
			}
			else if(Fe*dy<0 && Fw*dy>=0){
	...
	if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=0;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*De*dy+Fe*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(v_star[i][j]-v_star[i-2][j])+Fw*dy*PSI[i][j-1]*(v_star[i][j]-v_star[i][j-2])-Fn*dx*PSI[i+1][j]*(v_star[i+2][j]-v_star[i][j])-Fe*dy*PSI[i][j+1]*(v_star[i][j+2]-v_star[i][j]));
			}
			else if(Fe*dy>=0 && Fw*dy<0){
				...
				aE[i][j]=0;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+2*De*dy-Fw*dy+Fn*dx-Fs*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
				Sdc[i][j]=0.5*(Fs*dx*PSI[i-1][j]*(v_star[i][j]-v_star[i-2][j])+Fw*dy*PSI[i][j-1]*(v_star[i][j]-v_star[i][j-2])-Fn*dx*PSI[i+1][j]*(v_star[i+2][j]-v_star[i][j])+Fe*dy*PSI[i][j+1]*(v_star[i][j+2]-v_star[i][j]));
			}
			else if(Fe*dy<0 && Fw*dy<0){
	...
	for(j=3;j<=2*N-3;j=j+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=Dn*dx;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+Ds*dx+Fe*dy-Fw*dy+Fn*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
	...
	for(j=3;j<=2*N-3;j=j+2){
		...
		if(Fn*dx>=0 && Fs*dx>=0){
			if(Fe*dy>=0 && Fw*dy>=0){
				...
				aE[i][j]=De*dy;
				aN[i][j]=0;
				aP[i][j]=aE[i][j]+aW[i][j]+aN[i][j]+aS[i][j]+Dn*dx+Fe*dy-Fw*dy-Fs*dx;
				S[i][j]=(P_star[i-1][j]-P_star[i+1][j])*dx;
...
}while(!(error1<0.0001&&error2<0.0001));
...
int main(){
	...
	while(error1>0.0006 || error2>0.0006);
	fstream myfiley;
	//myfilex.open("uvalues.txt");
	myfiley.open("vvalues.txt");
	/*for (int i=1;i<=2*N-1;i=i+2)
	{
		for (int j=2;j<=2*N-2;j=j+2)
		{
